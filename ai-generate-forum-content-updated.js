 ...
 * 
 * Usage:
 * node ai-generate-forum-content-updated.js
 */
...
async function generateForumContent() {
  try {
    console.log("Starting AI-powered forum content generation...");
    
    // Insert posts for each category (using only first category for testing)
...
// Use the VITE_GEMINI_API_KEY (already set for the frontend)
...
async function generateForumContent() {
  try {
    ...
    if (!googleApiKey && !openaiApiKey) {
      ...
      console.log("To use AI-generated content, please set GOOGLE_AI_API_KEY or OPENAI_API_KEY in your environment variables.");
    }
