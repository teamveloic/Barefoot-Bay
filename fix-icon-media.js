/**
 * Script to fix icon media paths
 * 
 * This script ensures that all icon files in the /uploads/icons directory
 * are also available in the /icons directory for production access.
 */
 ...
 */
async function main() {
  console.log(`Starting icon media path fix`);
  ...
  if (devToProdCount + prodToDevCount > 0) {
    console.log(`\n✅ Icon media paths have been fixed successfully!`);
  } else {
    console.log(`\n✅ All icon media paths are already correctly synced.`);
  }
}
