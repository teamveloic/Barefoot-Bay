 ...
 * 
 * Usage:
 * node ai-generate-forum-content-es.js
 */
...
async function generateForumContent() {
  try {
    ...
    if (!googleApiKey && !openaiApiKey) {
      ...
      console.log("To use AI-generated content, please set VITE_GEMINI_API_KEY or OPENAI_API_KEY in your environment variables.");
    }
